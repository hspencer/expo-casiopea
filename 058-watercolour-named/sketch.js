...
// Curated colour palettes. Each cycle picks one at random; the paper
// background, figures and horizons all draw from that single palette so the
...
function generateComposition() {
  // Pick a curated palette for this cycle. Paper background, figures and
  // horizons all draw from it.
